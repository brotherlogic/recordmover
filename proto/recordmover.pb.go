...
func (x *RecordedMove) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
type Config struct {
	...
	NextUpdateTime map[int64]int64 `protobuf:"bytes,4,rep,name=next_update_time,json=nextUpdateTime,proto3" json:"next_update_time,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
type Context struct {
	...
	Before         *proto.Record `protobuf:"bytes,1,opt,name=before,proto3" json:"before,omitempty"` // DEPRECATED
	BeforeInstance int64         `protobuf:"varint,5,opt,name=before_instance,json=beforeInstance,proto3" json:"before_instance,omitempty"`
	Location       string        `protobuf:"bytes,2,opt,name=location,proto3" json:"location,omitempty"`
	After          *proto.Record `protobuf:"bytes,3,opt,name=after,proto3" json:"after,omitempty"` // DEPRECATED
	AfterInstance  int64         `protobuf:"varint,6,opt,name=after_instance,json=afterInstance,proto3" json:"after_instance,omitempty"`
...
func (x *Context) GetBefore() *proto.Record {
	if x != nil {
		return x.Before
	}
	return nil
...
func (x *Context) GetBeforeInstance() int64 {
	if x != nil {
...
func (x *Context) GetAfter() *proto.Record {
	if x != nil {
		return x.After
	}
	return nil
...
func (x *Context) GetAfterInstance() int64 {
	if x != nil {
...
type RecordMove struct {
	...
	Record        *proto.Record `protobuf:"bytes,5,opt,name=record,proto3" json:"record,omitempty"` // DEPRECATED
...
func (x *RecordMove) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *RecordMove) GetRecord() *proto.Record {
	if x != nil {
		return x.Record
	}
	return nil
...
func (x *ListRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *ClearRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
var file_recordmover_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x49, 0x6e, 0x73, 0x74,
	...
	0x63, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x61, 0x66, 0x74, 0x65, 0x72, 0x49,
...
var file_recordmover_proto_goTypes = []interface{}{
	...
	(*proto.Record)(nil),  // 13: recordcollection.Record
}
