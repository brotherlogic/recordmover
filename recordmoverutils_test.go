...
var movetests = []struct {
	...
	{&pbrc.Record{Release: &gdpb.Release{}, Metadata: &pbrc.ReleaseMetadata{Match: pbrc.ReleaseMetadata_FULL_MATCH, Category: pbrc.ReleaseMetadata_PRE_VALIDATE, GoalFolder: 1234}}, 812802},
